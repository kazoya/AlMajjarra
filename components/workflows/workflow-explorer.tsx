...
export function WorkflowExplorer() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <PageHeader
        title="رحلة المصنع والحقل"
        description="من الخامات إلى الخلط والتعبئة ثم الطلب والإرشاد والري. مرجع للنقاش لا وصف مؤكد لخطوط اليوم."
        demoLabel="يُراجع في الاكتشاف"
      />
      <HonestyNote>كل عقدة قابلة للنقر. أتمتة الري مقترح يُبنى مع الحقل، وليست قدرة معلنة على الموقع.</HonestyNote>
      ...
      <Card className="mt-6 shadow-sm">
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            ...
            <Badge variant="outline" className="mt-1 font-normal">{active.integration}</Badge>
          </div>
        </CardContent>
      </Card>
    </div>
