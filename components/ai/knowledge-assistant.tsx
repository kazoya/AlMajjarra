...
export function KnowledgeAssistant() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <PageHeader
        title="مساعد معرفة Galaxy"
        description="يجيب من الصفحات العامة. لا جرعة ولا فتح صمام إن لم يوجد مصدر."
        demoLabel="مصدر عام أو اعتذار"
      />
      <HonestyNote>النشرات الرقيقة (مثل ووتر سيفر) تُعلن كناقصة بدل اختراع تركيب.</HonestyNote>
      ...
      >
        ...
        <Button type="submit" className="cursor-pointer">اسأل</Button>
      </form>
      {active ? (
      ...
      <Accordion type="single" collapsible>
        <AccordionItem value="rag">
          ...
          <AccordionContent className="text-sm leading-7 text-muted-foreground">
            تُفهرس نشرات Galaxy المعتمدة وبرامج التغذية. كل إجابة تذكر المصدر. لا تعديل صيغة إنتاج من المحادثة.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </div>
