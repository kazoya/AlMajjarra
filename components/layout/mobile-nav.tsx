...
import { ClipboardList, Droplets, LayoutDashboard, MessageCircle, MoreHorizontal } from "lucide-react";
import { cn } from "@/lib/utils";

const items = [
  { href: "/", label: "الرئيسية", icon: LayoutDashboard, match: (p: string) => p === "/" },
  { href: "/irrigation", label: "الري", icon: Droplets, match: (p: string) => p.startsWith("/irrigation") },
